...
การตั้งเวอร์ชั่นอย่างมีความหมาย 2.0.0
=============================

บทความย่อ
--------

ควรตั้งตัวเลขให้เป็น MAJOR.MINOR.PATCH เพิ่มเลขขึ้นเมื่อ:

1. MAJOR (เมเจอร์) สร้าง API ตัวใหม่ที่ใช้กับตัวปัจจุบันไม่ได้
1. MINOR (ไมเนอร์) เพิ่มการทำงานที่ยังใช้กับตัวปัจจุบันได้
1. PATCH (แพช) แก้บักให้กับระบบปัจจุบัน

สามารถเพิ่มตัวเลขสัญลักษณ์สำหรับ
